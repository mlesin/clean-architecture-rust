...
use business::{
    ...
    usecases::{get_all_dog_facts::GetAllDogFactsUseCase, get_one_dog_fact_by_id::GetOneDogFactByIdUseCase, interfaces::UseCase},
};
...
async fn get_one_dog_fact_by_id(data: web::Data<AppState>, path: web::Path<(i32,)>) -> Result<HttpResponse, ErrorReponse> {
    ...
    let get_one_dog_fact_by_id_usecase = GetOneDogFactByIdUseCase::new(&fact_id, &*data.dogs_gateway);
