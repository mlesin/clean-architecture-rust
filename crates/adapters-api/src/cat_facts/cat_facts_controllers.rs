...
use application::usecases::interfaces::UseCase;
use application::usecases::{get_all_cat_facts::GetAllCatFactsUseCase, get_one_random_cat_fact::GetOneRandomCatFactUseCase};
